...
TBD - I'm using `org.ardverk.*` out of convenience and the I picked the name simply because I was watching [Hackers](http://en.wikipedia.org/wiki/Hackers_\(film\)) the other day and thought Gibson is a funny name. In particular in the context of `The Plaque` (I really dislike that tool some of us have to use at work - it's the plaque).
